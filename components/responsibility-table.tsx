...
export default function ResponsibilityTable({ categories, groups, onEdit, onDelete }: ResponsibilityTableProps) {
  ...
  return (
    <>
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        {groups.length === 0 ? (
          <p className="text-muted-foreground">No groups created yet. Add a group before creating categories.</p>
        ) : categories.length === 0 ? (
          <p className="text-muted-foreground">No categories created yet. Add your first category to get started.</p>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
      ...
      <AlertDialog open={alertOpen} onOpenChange={setAlertOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this category and all associated allocations.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
