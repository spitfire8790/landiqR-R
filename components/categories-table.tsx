              ...
              <Table className="w-full">
                <TableHeader className="bg-gray-100 dark:bg-gray-700 sticky top-0 z-10 shadow-sm">
                  <TableRow>
                    ...
                    <TableHead className="font-semibold text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700">
                      Source
                    </TableHead>
                      ...
                      <TableCell>
                        {category.sourceLink ? (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              window.open(category.sourceLink, "_blank")
                            }
          ...
          >
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-gray-600 dark:text-gray-300">
                This will permanently delete this category and remove all
                associated allocations. This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
